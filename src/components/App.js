    ...
    <div className={classes.container}>
        ...
        view === "euromillions"?
          ...
          view === "swisslotto"?
            ...
            <div className={classes.pannel}>
              <button type="button" onClick={() => setView("euromillions")} title="EuroMillions">
                <img src="/euroMillions.png" alt="EuroMillions" />
              </button>
              <button type="button" onClick={() => setView("swisslotto")} title="Swiss Lotto">
      ...
      <Nav className={classes.menuBtn} onSelect={handleMenuSelect}>
        <NavDropdown title={menuTitle} id="nav-dropdown">
          ...
          {view !== "euromillions" && (
            <>
              <NavDropdown.Item eventKey="euromillions"><img src="/euroMillions.png" alt="EuroMillions" width="48px" heigh="16px" /></NavDropdown.Item>
              <NavDropdown.Divider />
            </>
          )}
          {view !== "swisslotto" && (
            <>
              <NavDropdown.Item eventKey="swisslotto"><img src="/swissLotto.png" alt="Swiss Lotto" width="48px" heigh="16px" /></NavDropdown.Item>
              <NavDropdown.Divider />
            </>
          )}
          {isSignedIn && (
