...
interface FavoritesProps {
  favorites: number[];
  favoriteComponent: FC<ValueComponentProps>;
  onFavoriteClick: (value?: number, add?: boolean) => void;
}

export const Favorites = ({ favorites, favoriteComponent, onFavoriteClick }: FavoritesProps) => {
